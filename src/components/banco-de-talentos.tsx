...
/* ==========================================================================
   ...
   A mesma tela serve duas áreas, e é por isso que ela mora aqui e não numa
   rota: o gestor precisa procurar gente sem sair do painel da empresa. Antes o
   menu da empresa apontava para /app/talentos — a pessoa saía da própria área,
   caía na casca do aluno e perdia o acesso ao resto do painel.

   `base` é a área que está mostrando a tela: dela saem os links da ficha e das
   vagas, para a navegação nunca atravessar a fronteira.
   ========================================================================== */

const senioridades = ["Estagiário", "Júnior", "Pleno", "Sênior", "Especialista"];

export function BancoDeTalentos({ base = "/app" }: { base?: "/app" | "/empresa" }) {
  ...
  return (
    <div className="space-y-7">
      <div className="flex flex-wrap items-end justify-between gap-4">
        ...
        <Button href={base === "/empresa" ? "/empresa/vagas" : "/app/vagas"} variant="outline">
          Ver vagas abertas
        </Button>
      </div>
                ...
                return (
                  <Card key={t.id} hover className="flex h-full flex-col">
                    ...
                    <div className="mt-4 flex items-center justify-between border-t border-navy-100 pt-4">
                      ...
                      <Button href={`${base}/talentos/${t.id}`} variant="outline" size="sm">
                        Ver perfil
                      </Button>
                    </div>
                  </Card>
